...
exports.script = function(callback) {
    ...
    let rows = JSON.parse(fs.readFileSync(
        '../queue/json/Chart_Inventory_alleSysteme.xlsx/Stollberg_40.json'
    ));
    ...
    rows = Extractor.excludeColumns(rows,       [15, 14, 13, 11, 10, 9, 8, 7, 4, 2, 1 ,0]);
    header = Extractor.excludeColumns([header], [15, 14, 13, 11, 10, 9, 8, 7, 4, 2, 1 ,0])[0];
    // Header: [ 'systemname', 'Inventory No', 'Rack', 'Seriennummer' ]
